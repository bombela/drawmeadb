/* $Id: gvtextlayout_pango.c,v 1.26 2008/01/29 16:34:12 ellson Exp $ $Revision: 1.26 $ */
...
/* #define ENABLE_PANGO_XSHOW */
    ...
    {
	    printf("Pango error : %s\n", error->message);
	    printf("Text : %s\n", para->str);
	    exit(10); // Yes, you can beat me.
    }
#else
    text = para->str;
	printf("Pango textlayout (simple) : %s\n", text);
#endif
